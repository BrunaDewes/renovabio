...
- `login.tsx`, `cadastro.tsx`, `recuperar.tsx`: autenticacao e recuperacao de conta.
- `home.tsx`: tela inicial apos login.
- `perfil.tsx`: dados do usuario, foto e informacoes de conta.
- `desafios.tsx`, `desafio-detalhe.tsx`, `historico-desafios.tsx`: fluxo de desafios sustentaveis.
