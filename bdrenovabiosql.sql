CREATE DATABASE  IF NOT EXISTS `bdrenovabio` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bdrenovabio`;
-- MySQL dump 10.13  Distrib 8.0.36, for Win64 (x86_64)
--
-- Host: shuttle.proxy.rlwy.net    Database: bdrenovabio
-- ------------------------------------------------------
...
-- Dump completed on 2026-06-21  2:56:31
